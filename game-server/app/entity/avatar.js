...
var Avatar = function (opts) {
    ...
    opts.components = ['avatarProp', 'bag', 'friend', 'match', 'hero',
        'dungeon', 'ladder', 'team', 'raid', 'mail', 'gm','tutorial','card'];
...
pro.getDBProp = function () {
    ...
    props['tutorial'] = this.tutorial.getPersistData();
    props['card'] = this.card.getPersistData();
    return props;
};
...
pro.clientLoginInfo = function () {
    return {
        ...
        tutorialInfo: this.tutorial.getClientInfo(),
        cardInfo:this.card.getClientInfo()
    }
};
